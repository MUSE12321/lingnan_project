...
public class BedServiceImpl implements BedService {
	...
	public Page<Device> query(BedQuery bedQuery) {
		...
		String SQL = "select * from device where location='卧室'"
				+ bedQuery.getWhereSQL();
		...
		// 当前查询条件下的记录数
		int count = findCount(
				"select count(*) from device where location='卧室' "
						+ bedQuery.getWhereSQL(), bedQuery.getWhereParams());
